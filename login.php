    ...
    <div class="container shadow">
        <form>
            ...
            <div>
                ...
                <input type="text" placeholder="Username" id="login-user"></td>
            </div>
            <div>
                <label for="Password">Password</label></td>
                <input type="password" placeholder="Password" id="login-pass"></td>
            </div>
            <div class="extension">Don't have any account? <a href="register.php">Create one,</a></div>
            <button class="btn btn-submit" type="button" id="btn-signin">Sign in</button>
        </form>
    </div>
</section>
<?php
